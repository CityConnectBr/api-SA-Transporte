...
class TiposSolicitacaoDeAlteracaoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('tipos_solicitacao_de_alteracao')->insert([
            ...
            'regex_campo3' => '^\([1-9]{2}\) (?:[2-8]|9[1-9])[0-9]{3}\-[0-9]{4}$',
            'nome_campo4' => 'celular',
            'desc_campo4' => 'celular',
            'regex_campo4' => '^\([1-9]{2}\) (?:[2-8]|9[1-9])[0-9]{3}\-[0-9]{4}$',
        ]);
        DB::table('tipos_solicitacao_de_alteracao')->insert([
            'id' => '2',
        ...
        DB::table('tipos_solicitacao_de_alteracao')->insert([
            ...
            'regex_campo6' => '^\([1-9]{2}\) (?:[2-8]|9[1-9])[0-9]{3}\-[0-9]{4}$',
            'nome_campo7' => 'celular',
            'desc_campo7' => 'celular',
            'regex_campo7' => '^\([1-9]{2}\) (?:[2-8]|9[1-9])[0-9]{3}\-[0-9]{4}$',
            'nome_campo8' => 'cep',
            'desc_campo8' => 'cep',
            'regex_campo8' => '^(\d{8})$',
        ...
        DB::table('tipos_solicitacao_de_alteracao')->insert([
            ...
            'nome_campo5' => 'celular',
            'desc_campo5' => 'celular',
            'regex_campo5' => '^\([1-9]{2}\) (?:[2-8]|9[1-9])[0-9]{3}\-[0-9]{4}$',
        ]);
        DB::table('tipos_solicitacao_de_alteracao')->insert([
            'id' => '11',
        ...
        DB::table('tipos_solicitacao_de_alteracao')->insert([
            ...
            'regex_campo2' => '^\([1-9]{2}\) (?:[2-8]|9[1-9])[0-9]{3}\-[0-9]{4}$',
        ]);
        DB::table('tipos_solicitacao_de_alteracao')->insert([
            'id' => '21',
