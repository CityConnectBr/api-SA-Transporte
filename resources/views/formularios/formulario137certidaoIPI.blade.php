...
<body>
    <div class="content">
        ...
        <h3>CERTIDÃO SA-TRANS/DTP/GCOC N.º158.2014</h3>
        ...
        <p style="text-align: justify;">
            ...
            <b>DECLARA</b> sob as penas da Lei, para fins de isenção de <b>IPI</b>, que o(a) Sr(a).
            ...
            características: marca/modelo <b>{{$certidao['marcaModeloVeiculo']['descricao']}}</b>, cor <b>{{$certidao['cor']['descricao']}}</b>, ano de fabricação <b>{{$certidao['ano_fabricacao']}}</b>,
            placa: <b>{{$certidao['placa']}}</b>. Declaração elaborada em 05 dezembro de 2014 e conferida por
            {{$empresa['nome_do_gerente']}}.
        </p>
